...
export function Panel({ children, title }: Readonly<{ children: ReactNode; title: string }>) {
...
export function Empty({ description, icon, text }: Readonly<{ description?: string; icon: ReactNode; text: string }>) {
