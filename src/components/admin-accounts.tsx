...
import { CheckCircle2, Edit3, KeyRound, MoreHorizontal, ShieldCheck, ShieldOff, UserPlus, X } from "lucide-react";
...
type DialogState = { type: "create" | "edit" | "password" | "twoFactor" | "disable"; user?: AdminUser } | null;
...
export function AdminAccounts() {
  ...
  function openDialog(next: DialogState) { setError(""); setTemporaryPassword(""); setDialog(next); }
