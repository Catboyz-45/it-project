...
อัปเดตล่าสุด: 19 กันยายน 2569 เวลา 13:09

## สรุปแบบสั้น

- มี URL API ทั้งหมด **115 เส้นทาง**
- เมื่อนับ HTTP method แยกกัน มีการทำงานที่เรียกได้ทั้งหมด **146 รายการ**
...
| Method | URL | ใช้ทำอะไร |
|---|---|---|
| `GET` `POST` | `/api/legal/preferences` | อ่านหรือจัดการpreferencesตาม HTTP method และสิทธิ์ของผู้ใช้ |
