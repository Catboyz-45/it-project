 ...
 * ภาพรวมไฟล์: เป็น API GET ที่ URL /api/v1/admin/properties/[propertyId]/dashboard/summary สำหรับเจ้าของหอหรือผู้ดูแลหอ
...
export async function GET(request: NextRequest, context: Context) {
  try {
    ...
    return NextResponse.json({ data: await getOwnerDashboardAggregation(propertyId) });
  } catch (error) {
